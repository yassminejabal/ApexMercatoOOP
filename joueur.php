...
class joueur extends Person{
    private string $role;
    public int $Prime_de_signature = 1200;
    public int $Salaire_mensuel =20000;
...
<div class="team-badges">
  ...
  <span class="team-badge" style="background:#f39c12;">3 → FC Champions</span>
    ...
    <button name="submit" type="submit"><a href="crud_jeur/indexx.php">Ajouter le joueur</a></button>
  </form>
