...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Click effect: shrink + shake animation */
    .delete-btn:active {
  ...
  <main class="container">
    ...
    <div class="teams">
      ...
      <?php foreach ($data as $row) { ?>
        <div class="team-card">
          <div class="team-info">
            <button class="delete-btn"><a href="deleteEq.php?id=<?=$row['id']?>">Delete</a></button>
            <button class="delete-btn"><a href="updateEq.php?id=<?=$row['id']?>">update</a></button>
